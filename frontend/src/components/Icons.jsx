/** Small inline SVGs — reliable across browsers (no emoji font dependency). */

export function IconSearch({ size = 18, className, style, ...rest }) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconPackage({ size = 18, ...rest }) {
  return (
...
export function IconSettings({ size = 18, ...rest }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden {...rest}>
...
export function IconTrash({ size = 18, ...rest }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden {...rest}>
      <path d="M3 6h18" />
